function [ angle ] = calculate_direction_difference( unit_vector_1, ...
    unit_vector_2 )
    %calculate_direction_difference calculates the angle between two unit 
    %vectors
...
along with this program.  If not, see <http://www.gnu.org/licenses/>.
    ...
    dot_prod = sum(unit_vector_1 .* unit_vector_2);
