function [SpeakerArray, B_Format_Channels_Struc, Decoder, Filters, ...
    speaker_feeds] = ... 
    convert_B_Format_to_speaker_feeds(B_format_file, encodingConvention, ...
    binaural)
%convert_B_Format_to_speaker_feeds takes B-Format audio file of encoding 
...
%% create decoder
[Decoder, SpeakerArray] = create_decoder_using_pseudoinverse(SpeakerArray, ...
...
[SpeakerArray, speaker_feeds] = calculate_speaker_feeds(SpeakerArray, ...
    B_Format_Channels_Struc, Decoder);

%% perform binaural conversion
if binaural
    speaker_feeds_to_binaural(SpeakerArray, B_Format_Channels_Struc, ...
        B_format_file);
end
